...
- portal-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- portal-ui: main application module, development time
- portal-production: module that produces a production mode WAR for deployment
