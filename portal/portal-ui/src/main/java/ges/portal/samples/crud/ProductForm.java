package ges.portal.samples.crud;

import java.util.Collection;

import ges.portal.samples.backend.DataService;
import ges.portal.samples.backend.data.Availability;
import ges.portal.samples.backend.data.Category;
import ges.portal.samples.backend.data.Product;
